...
# python3.9 generategrid.py -t square5 -r 5 -n 25
...
parser.add_argument("--number", "-n", type=int, default=10, help="prefix of output file name")
parser.add_argument("--output-name", "-o", type=str, default="ex")
parser.add_argument("--template", type=str, default="template.csc")
parser.add_argument("--node-template", type=str, default="nodetemplate.csc")
parser.add_argument("--pcap-name", "-p", type=str, default="{{TITLE}}")
parser.add_argument("--init-numb", "-i", type=int, default=1)


args = parser.parse_args()

SERVER_POS = (0, 0)
zeroes = floor(log10(args.number)) + 1
